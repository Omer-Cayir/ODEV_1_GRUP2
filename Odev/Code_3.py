...
class DTMFGenerator:
    ...
    def play_dtmf(self, char):
        ...
        # Sinyal toplamı ve genlik normalizasyonu 
        ...
        # Grafiği çiz 
        self.ax.clear()
        self.ax.plot(t[:400], signal[:400], color='red') # Daha net görünmesi için ilk 400 örnek
        self.ax.set_title(f"{char} Tuşu Birleşik Sinyal (x(t) = sin(2π{f_low}t) + sin(2π{f_high}t))")
